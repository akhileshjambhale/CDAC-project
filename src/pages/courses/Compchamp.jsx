...
return(
  <div>
     <Container>
      ...
      <Carousel.Item>
        <img
          ...
          src="images/Computer_Course.jpg"
          alt="First slide"
          width={300}
          height={400} 
        />
    ...
    <Card>
        <Card.Header align="center" color="Dark"><h2><b>Comp Champ</b>(Age Group-9 to 14)</h2></Card.Header>
        <Card.Body>
