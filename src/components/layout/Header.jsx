    ...
    <>
      ...
      <header id="header" className="d-flex align-items-center">
        <div className="container d-flex align-items-center justify-content-between">
          <div className="logo">
            <h1>
              <a href="index.html">COMPUTER-SEEKHO</a>
            </h1>
          ...
          <nav id="navbar" className="navbar">
            <ul>
              ...
              <li>
                  ...
                  <Link className="nav-link scrollto" to={"/Faculty"}>Faculty</Link>
                  
              
              </li>
              <Link className="nav-link scrollto active" to={"/Album"} >Gallery </Link>
               ...
               */}
              <li>
              <Link className="nav-link scrollto" to={"/ContactUs"}>Contact Us</Link>
